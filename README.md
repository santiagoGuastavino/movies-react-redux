...
[some other link?](https://other-relevant-link/)
...
This REST API has been deployed to [Heroku](https://devcenter.heroku.com/start). It has a [ClearDB addon](https://elements.heroku.com/addons/cleardb) instance that hosts a remote MySQL Database. -->